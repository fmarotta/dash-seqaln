...
/***/ "./node_modules/css-loader/dist/cjs.js!./src/lib/components/DashSeqaln.react.css":
/*!***************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js!./src/lib/components/DashSeqaln.react.css ***!
  \***************************************************************************************/
/*! no static exports found */
...
/***/ "./src/lib/components/DashSeqaln.react.css":
/*!*************************************************!*\
  !*** ./src/lib/components/DashSeqaln.react.css ***!
  \*************************************************/
/*! no static exports found */
...
var content = __webpack_require__(/*! !../../../node_modules/css-loader/dist/cjs.js!./DashSeqaln.react.css */ "./node_modules/css-loader/dist/cjs.js!./src/lib/components/DashSeqaln.react.css");
...
if(true) {
	module.hot.accept(/*! !../../../node_modules/css-loader/dist/cjs.js!./DashSeqaln.react.css */ "./node_modules/css-loader/dist/cjs.js!./src/lib/components/DashSeqaln.react.css", function() {
		var newContent = __webpack_require__(/*! !../../../node_modules/css-loader/dist/cjs.js!./DashSeqaln.react.css */ "./node_modules/css-loader/dist/cjs.js!./src/lib/components/DashSeqaln.react.css");
...
function DashSeqaln(props) {
  ...
  var _props$labelWidth = props.labelWidth,
    ...
    scaleWidth = _props$scaleWidth === void 0 ? 0 : _props$scaleWidth,
    _props$scrollViewport = props.scrollViewportWidth,
    scrollViewportWidth = _props$scrollViewport === void 0 ? 0 : _props$scrollViewport,
    _props$ticking = props.ticking,
    ticking = _props$ticking === void 0 ? false : _props$ticking,
    _props$renderBounds = props.renderBounds,
    renderBounds = _props$renderBounds === void 0 ? [0, alnLength] : _props$renderBounds;
  var highlightedRow = props.highlightedRow,
    highlightedCol = props.highlightedCol;
  var labelRef = Object(react__WEBPACK_IMPORTED_MODULE_0__["useRef"])(null);
  var scaleRef = Object(react__WEBPACK_IMPORTED_MODULE_0__["useRef"])(null);
  var scrollViewportRef = Object(react__WEBPACK_IMPORTED_MODULE_0__["useRef"])(null);
...
/*!**************************!*\
  !*** ./src/lib/index.js ***!
  \**************************/
/*! exports provided: DashSeqaln */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_DashSeqaln_react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/DashSeqaln.react */ "./src/lib/components/DashSeqaln.react.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "DashSeqaln", function() { return _components_DashSeqaln_react__WEBPACK_IMPORTED_MODULE_0__["default"]; });
...
/***/ "./src/lib/msa_color_schemes.js":
/*!**************************************!*\
  !*** ./src/lib/msa_color_schemes.js ***!
  \**************************************/
/*! exports provided: color_msa_column */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "color_msa_column", function() { return color_msa_column; });
...
function color_msa_column(column, scheme) {
  if (!scheme) return make_blank_scheme(column);
  if (scheme === "Blosum62") return make_blosum_scheme(column);
  if (scheme === "ClustalX") return make_clustalx_scheme(column);else return make_static_scheme(column, scheme);
}
function make_blank_scheme(column) {
  return column.map(function (x) {
    return "#ffffff";
  });
}
function make_static_scheme(column, scheme) {
  return column.map(function (x) {
    return static_schemes[scheme][x];
  });
}
function make_blosum_scheme(column) {
  ...
  var consensus = "*";
  var occurrences = {};
  var most_occurrences = 0;
  var _iterator = _createForOfIteratorHelper(column),
    _step;
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      var c = _step.value;
  ...
  return column.map(function (x) {
    return x === "-" ? "#ffffff" : blosum62_palette[Math.floor((blosum62[consensus][x] + 4) / 2)];
  });
}
function make_clustalx_scheme(column) {
  ...
  var _loop = function _loop() {
    var g = _arr[_i];
    frac[g.join("")] = column.filter(function (x) {
      return g.includes(x);
    }).length / n;
  };
  for (var _i = 0, _arr = [["W", "L", "V", "I", "M", "A", "F", "C", "H", "P"], ["K", "R"], ["Q", "E"], ["E", "D"], ["T", "S"]]; _i < _arr.length; _i++) {
    _loop();
  }
  var _iterator2 = _createForOfIteratorHelper("KRQEDNYSTCGPWAFHILMV"),
    _step2;
  try {
    var _loop2 = function _loop2() {
      var a = _step2.value;
      frac[a] = column.filter(function (x) {
        return x == a;
      }).length / n;
    };
  ...
  var is_hydrophobic = frac["WLVIMAFCHP"] > .6;
  var is_positive = frac["KR"] > .6 || Math.max(frac["K"], frac["R"], frac["Q"]) > .8;
  var is_negative_E = frac["KR"] > .6 || frac["QE"] > .5 || Math.max(frac["E"], frac["Q"], frac["D"]) > .85;
  var is_negative_D = frac["KR"] > .6 || frac["ED"] > .5 || Math.max(frac["K"], frac["R"], frac["Q"]) > .85;
  var is_polar_N = frac["N"] > .5 || Math.max(frac["N"], frac["Y"]) > .85; // eh?
  var is_polar_Q = frac["KR"] > .6 || frac["QE"] > .5 || Math.max(frac["Q"], frac["E"], frac["K"], frac["R"]) > .85;
  var is_polar_ST = frac["WLVIMAFCHP"] > .6 || frac["TS"] > .5 || Math.max(frac["S"], frac["T"]) > .85;
  var is_cystein = frac["C"] > .85;
  var is_glycine = frac["G"] > .0;
  var is_prolyne = frac["P"] > .0;
  var is_aromatic = frac["WLVIMAFCHP"] > .6 || Math.max(frac["W"], frac["Y"], frac["A"], frac["C"], frac["P"], frac["Q"], frac["F"], frac["H"], frac["I"], frac["L"], frac["M"], frac["V"]);
  var _iterator3 = _createForOfIteratorHelper(column),
    _step3;
  try {
...
var blosum62_palette = ["#c5e7ff", "#abcfe9", "#91b8d3", "#78a1be", "#5f8ba9", "#457594", "#2a6080", "#004c6d"];
...
//# sourceMappingURL=7e1abd3-main-wps-hmr.js.map
//# sourceMappingURL=data:application/json;charset=utf-8;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiI3ZTFhYmQzLW1haW4td3BzLWhtci5qcyIsInNvdXJjZVJvb3QiOiIifQ==